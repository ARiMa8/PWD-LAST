...
const Gallery = () => {
  return (
    <div className='bg-cyan-200 m-auto'>
      <div className="bg-blue-200 mx-auto pt-36 text-center">
        ...
        <div className="bg-gray-200 border shadow-2xl p-4 mr-12 ml-12">
          ...
          <div className="col-span-2 grid grid-cols-4 gap-4">
            <div style={{ position: 'relative', height: '366px' }}>
              <img
                style={{ width: '340px', height: '326px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
                src="https://cdn.discordapp.com/attachments/1086315786446061711/1127275207846019162/7-4.jpg"
                alt="A-BW1-1"
              />
            </div>
            <div style={{ position: 'relative', height: '429px' }}>
              <img
                style={{ width: '340px', height: '389px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
            ...
            <div style={{ position: 'relative', height: '370px' }}>
              <img
                style={{ width: '285px', height: '330px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
            ...
            <div style={{ position: 'relative', height: '400px' }}>
              <img
                style={{ width: '285px', height: '360px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
            ...
            <div style={{ position: 'relative', height: '320px' }}>
              <img
                style={{ width: '340px', height: '382px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
            ...
            <div style={{ position: 'relative', height: '320px' }}>
              <img
                style={{ width: '285px', height: '380px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
            ...
            <div style={{ position: 'relative', height: '320px' }}>
              <img
                style={{ width: '285px', height: '350px', position: 'absolute', bottom: 0, borderRadius: '20px' }}
