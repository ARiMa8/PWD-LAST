...
const Destinations = () => {
    ...
    return (
        <div className='bg-cyan-200 m-auto'>
            <div className='bg-cyan-200 m-auto px-4 relative group'>
                <div className='bg-gray-200 border drop-shadow-2xl'>
                    <br></br>
                    <div class="flex justify-center items-center h-52">
                        <div class="bg-gray-200 rounded-lg px-4 py-2">
                            <h1 class="text-4xl text-center font-Poppins pt-20 font-bold">Find Your Favorite Dream Destination</h1>
                    ...
                    <div className='bg-gray-200 border rounded-2xl drop-shadow-2xl'>
                        {slides[currentIndex].type === 'image' ? (
                            <div
                                ...
                                className='rounded-2xl bg-center bg-cover duration-500 ml-2'
                            ></div>
                        ) : (
