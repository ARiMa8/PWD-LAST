  ...
  return (
    <div className="bg-slate-100 flex flex-col items-center mt-36">
      ...
      <div class="container mx-auto py-8">
        <Reveal>
          <h2 className="text-center text-2xl font-bold mb-4 font-Poppins">Form Kritik & Saran</h2>
